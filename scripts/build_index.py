...
add(f"""
  <section id="question">
    ...
    <p>Different voting methods can elect different winners from the same ballots — that is the entire reason this tool exists. Plurality rewards first-place strength; Borda rewards broad support; Condorcet methods reward head-to-head dominance; IRV rewards surviving eliminations. <code>voting</code> stores one set of inputs — options, voters, ballots — and offers 35 method names and aliases, enforcing compatible ballot types and seat counts.</p>
